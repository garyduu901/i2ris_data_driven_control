...
def main():
    ...
    ts = message_filters.ApproximateTimeSynchronizer([img_ts_sub, img_sub0, encoder_sub1], 10,  slop=0.05, allow_headerless=True)
    ...
    #0208
    test_data = pd.read_csv('inv_model_test_5_cycle_pitch_motor.csv')
    waypoints = test_data.iloc[:, 1].tolist()
    print(waypoints)
